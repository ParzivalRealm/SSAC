function Stories(){
  ...
  <div class="flex flex-col w-full p-9">
     ...
     <h1 className='normal-case text-7xl p-8 text-primary'>Generating positive impact on the industry</h1>
     <p className="text-2xl pb-8 px-8 text-accent">Know about the success stories we have created along our customers</p>
    <div class="card lg:card-side bg-base-100 m-8">
      ...
      <div class="card-body bg-primary">
        ...
        <div class="card-actions justify-end">
          <button class="btn btn-accent text-base-100">Watch Video</button>
        </div>
      </div>
    </div>
    ...
    <div class="divider"><button class="btn btn-accent text-base-100">See all</button></div> 
