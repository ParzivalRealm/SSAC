    ...
    <div class="card lg:card-side bg-base-100 m-8 rounded-none">
      ...
      <div class="card-body bg-primary">
        ...
        <div class="card-actions justify-end">
          <Link to="Success/Successstory/Offshore_Crude_Mixing"><button class="btn btn-primary text-base-100 rounded-none">Read More</button></Link>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col-reverse w-full">
      <div class="card lg:card-side bg-base-100 m-8 rounded-none">
        <div class="card-body bg-primary">
          ...
          <Link to="Success/Successstory/USS_Nassau_Ship"><button class="btn btn-primary text-base-100 rounded-none">Read More</button></Link>
          </div>
        </div>
        <figure><img src="https://placeimg.com/400/400/arch" alt="Album"></img></figure>
      </div>
    </div>
    <div class="divideer w-full"><Link to="Success/"><button class="btn btn-primary text-base-100 rounded-none">See all</button></Link></div> 
